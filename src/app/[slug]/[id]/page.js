...
function BookingPage() {
  return (
    <div className="flex h-full items-center justify-center min-h-[100dvh]">
      <div className="flex min-h-full w-full flex-col overflow-clip md:over  items-center ">
        <div className="grid min-w-full items-start md:grid-cols-3 md:grid-rows-1  sm:motion-reduce:transition-none md:flex-row sm:transition-[width] sm:duration-300">
          <div>
          ...
          <div className="flex flex-col px-5 py-3 items-start min-w-full">
