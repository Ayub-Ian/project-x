  ...
  return (
    <div className=" flex min-h-screen flex-col justify-center py-12 sm:px-6 lg:px-8">
      <h3 className="mx-auto mb-auto">
        <strong>
          <div className="h-4 w-auto">
            <h2 className="w-full text-center">Project X</h2>
          </div>
        </strong>
      </h3>
      ...
      <div className="mb-auto mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-[#1f1f1f] border-[#383838] mx-2 rounded-md border px-4 py-10 sm:px-10">
          {errorMsg && (
            <div className="bg-red-400/10 border transition border-red-500 text-red-700 block w-full p-2.5 rounded-md mb-3 text-sm">
              {errorMsg}
            </div>
          )}
          <Formik
          ...
          >
            {({ isValid, isSubmitting }) => (
              <Form className="column space-y-6">
                <TextField
                  label="Email address"
                  id="email"
                  name="email"
                ...
                <div className="relative">
                  ...
                  <div className="absolute -top-[5px] right-0 ltr:right-0 rtl:left-0">
                    <Link
                      href="/reset-password"
                      className="text-[#d6d6d6] text-sm font-medium"
                    >
                      Forgot password?
                    </Link>
                  </div>
        ...
        <div className="text-[#d6d6d6] mt-8 text-center text-sm hover:underline">
